...
options.UseSqlServer(builder.Configuration.GetConnectionString("Ciocan_Felicia_Lab2Context") ?? 
throw new InvalidOperationException("Connectionstring 'Ciocan_Felicia_Lab2Context' not found.")));
