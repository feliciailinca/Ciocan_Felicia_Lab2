...
namespace Ciocan_Felicia_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Ciocan_Felicia_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Ciocan_Felicia_Lab2Context context,string[] selectedCategories, Book bookToUpdate)
        {
